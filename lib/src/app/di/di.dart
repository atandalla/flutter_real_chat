...
import 'package:real_chat/src/packages/data/chat/lib/src/application/update_user_status_use_case.dart';
import 'package:real_chat/src/packages/data/device/device.dart';
import 'package:real_chat/src/packages/features/chat_detail/chat_detail.dart';
import 'package:real_chat/src/packages/features/home/src/bloc/home_bloc.dart';
...
Future<void> init() async {
  ...
  sl.registerLazySingleton(() => LogInWithPhoneUseCase(sl(), sl()));
  ...
  sl.registerLazySingleton(() => const PhoneValidator());
  ...
  /// Login Phone
  /// //Bloc
  sl.registerFactory(() => PhoneBloc(sl()));
